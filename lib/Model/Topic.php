...
class Topic implements ModelInterface, ArrayAccess
{
     ...
     * Sets name
     *
     * @param string $name Unique name identifier representing a notification topic
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description A description of what events are notified in this topic
     *
     * @return $this
     */
