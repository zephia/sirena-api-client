 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SavingPlanProduct implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['good_type'], $allowedValues)) {
    ...
    {
        $allowedValues = $this->getGoodTypeAllowableValues();
        if (!is_null($good_type) && !in_array($good_type, $allowedValues)) {
