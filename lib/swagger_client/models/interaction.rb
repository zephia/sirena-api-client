...
module SwaggerClient
  ...
  class Interaction
    ...
    # Specifies if the interaction was started by the agent (proactive interaction) or not
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'proactive')
    ...
    def hash
      [id, agent_id, prospect_id, created_at, due_at, started_at, finished_at, status, proactive, output].hash
    end
