...
module SwaggerClient
  ...
  class Quote
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'prospectId')
        self.prospect_id = attributes[:'prospectId']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["pending", "accepted", "rejected"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["pending", "accepted", "rejected"])
    ...
    def hash
      [id, prospect_id, status, items, total, created_at, rejected_at, accepted_at].hash
    end
